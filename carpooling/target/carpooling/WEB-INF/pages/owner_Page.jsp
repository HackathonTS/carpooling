...
<script type="text/javascript" src="<spring:url value="/resources/easyrtc/easyrtc_owner.js" />"></script>
...
<script type="text/javascript">
	...
	function callajax(){
		...
		var dest = $( "#dest" ).val();
		$.ajax({
			url: "/carpooling/algo?source="+src+"&dest="+dest, 
			type: "GET",
...
<body >
	...
	<div class="container-fluid" style="padding: 0px">
		<header id="top" class="header">
			<div class="text-vertical-center clr" style="font-family :'Trebuchet MS', Helvetica, sans-serif">
				<h1>Car Pooling</h1>
				<h3>Would you like to offer a drop?</h3>
				<br>
				<!--<a href="#about" class="btn btn-dark btn-lg">Find Out More</a>-->
			</div>
		</header>

		<div class="main" style="font-family :'Trebuchet MS', Helvetica, sans-serif">
			...
			<div class="example row">
				<div class="col-md-12">
					<ul id="nav">
						...
						<li><select class="form-control" style="display:none" id="dest" onchange="callajax();">
			...
			<div class="row" style="display:none" id="chat">
				<div class="col-md-8" style="padding: 35px">
					<div style="color: white"><h3>Shortest path to your destination
						would be via :</h3></div>
					<br />
					<div style="color: white" id ="output"></div><br />
